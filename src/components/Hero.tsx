    ...
    padding: isMobile ? '100px 12px 40px' : '120px 20px 60px'
      ...
      <div className="container px-4 sm:px-6 lg:px-8" ref={containerRef}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="section-title text-3xl sm:text-4xl lg:text-5xl xl:text-6xl leading-tight opacity-0 animate-fade-in mb-6" style={{
          animationDelay: "0.3s"
        }}>
          ...
          animationDelay: "0.9s"
            ...
            <a href="#products" className="flex items-center justify-center group w-full sm:w-auto text-center" style={{
